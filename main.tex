...
Le fondement de l'Adaboost part du principe d'algorithmes de "Boosting"
Propriétées : 
- Origine ?
- Principe (que fait-on ?)

Faire le lien et comparer avec Bagging et SVM
Pas aussi intéressant que le Bagging dans certains cas
